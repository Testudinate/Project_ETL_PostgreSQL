            ...
            with codecs.open(load_file, 'r',encoding='utf-8',errors='ignore') as f:
                ...
                for row2 in csv_data:
                    ...
                    s = "VALUES("+str(row2[0])+","+str(row2[1])+","+str(row2[2])+","\
                                 ...
                                 +str(row2[26])+","+str(row2[27])+","+str(row2[28])+","+str(row2[29])+","+str(row2[30])+",'"+str(rowi[1])+"')"
                    s0 =  'INSERT INTO "prd_db_stg"."05_object_radiuses_rubrica_1st" (city ,id_sq ,'\
                    ...
                    '"2600-2700","2700-2800","2800-2900","2900-3000","file_name")'
                    sql_code_1 = s0 + s
                    #print(sql_code_1)
