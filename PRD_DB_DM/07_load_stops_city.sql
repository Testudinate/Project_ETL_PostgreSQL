...
-- select count(*) from prd_db_stg."07_stops_city"
-- select count(*) from prd_db_dm."07_stops_city" 
delete from prd_db_dm."06_flat_city" ;

select prd_db_dm."07_load_stops_city"(21);
...
CREATE OR REPLACE FUNCTION prd_db_dm."07_load_stops_city"(in_city integer)
RETURNS integer AS $$
...
insert into prd_db_dm."07_stops_city" (
city ,
  id_sq ,
  "0-100" ,
  "100-200" ,
...
$$ LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION prd_db_dm."07_load_stops_city"(integer)
OWNER TO admin_etl;
